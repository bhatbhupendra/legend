...
<head>
    ...
    <title>Wellway Inventory</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&display=swap" rel="stylesheet">
    <style>
    /* ════════════════════════════════════════════
       WELLWAY LAYOUT — Matching Dashboard Style
       ════════════════════════════════════════════ */
...
<body>
    ...
    <div class="igl-shell">
        ...
        <aside class="igl-sidebar" id="igl-sidebar">
            ...
            <!-- Brand -->
            <a href="{{ route('wellway.index') }}" class="igl-sidebar-brand">
                <div class="igl-sidebar-brand-icon">📦</div>
                <div class="igl-sidebar-brand-text">
                    <strong>Wellway</strong>
            ...
            <div class="igl-sidebar-nav">
                ...
                <a href="{{ route('wellway.index') }}"
                    class="igl-nav-link {{ request()->routeIs('wellway.index') ? 'active' : '' }}">
                ...
                <a href="{{ route('wellway.products') }}"
                    class="igl-nav-link {{ request()->routeIs('wellway.products') ? 'active' : '' }}">
                    <svg class="igl-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <!-- Top face -->
                ...
                <a href="{{ route('wellway.create') }}"
                    class="igl-nav-link {{ request()->routeIs('wellway.create') ? 'active' : '' }}">
                    <svg class="igl-nav-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <a href="{{ route('wellway.allMovements') }}"
                    class="igl-nav-link {{ request()->routeIs('wellway.allMovements') ? 'active' : '' }}">
                    <svg class="igl-nav-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <header class="igl-topbar">
                <div class="igl-topbar-left">
                    ...
                    <nav class="igl-breadcrumb">
                        <a href="{{ route('wellway.index') }}">wellway</a>
                        <span class="sep">›</span>
                        <span class="current">
                            @if(request()->routeIs('wellway.index')) Overview
                            @elseif(request()->routeIs('wellway.create')) Add Product
                            @elseif(request()->routeIs('wellway.allMovements')) Movements
                            @elseif(request()->routeIs('wellway.edit')) Edit Product
                            @else Dashboard
                            @endif
                        </span>
                    </nav>
