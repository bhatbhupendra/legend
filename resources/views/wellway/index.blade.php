...
<div class="dash-panel">
    ...
    <div class="dash-panel-header">
        <div class="dash-panel-header-left">
            <div>
                <p class="dash-panel-title">📦 Wellway Inventory Dashboard</p>
    ...
    <div class="dash-btn-block">
        ...
        <div class="dash-btn-row">
            ...
            <a href="" class="dash-hdr-btn primary">
        ...
        <div class="dash-btn-row">
            ...
            <a href="{{ route('wellway.allMovements') }}" class="dash-action-btn solid-teal">
            ...
            <a href="" class="dash-action-btn solid-amber">
