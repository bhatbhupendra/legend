...
@section('content')
<div class="box-panel">
    <h4 class="mb-3">Stock Out / Sell - {{ $product->name_en }}</h4>
    ...
    <form action="{{ route('wellway.stockout', $product->id) }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <label class="form-label">Quantity Sold / Shipped</label>
        ...
        <button type="submit" class="btn btn-warning btn-custom">Remove Stock</button>
