...
<div class="table-box">
    <div class="etbl-wrapper" id="mtbl-main">

        {{-- ── TOP BAR ── --}}
        <div class="etbl-topbar">
            <div class="etbl-title">
                All Stock Movements
                <span class="etbl-count" id="mtbl-total-count">{{ $movements->total() }} total</span>
            </div>

            <div class="etbl-topbar-right">
                <a href="{{ route('igloohome.movements.export.excel', request()->query()) }}"
                ...
                <div class="etbl-search-wrap">
                    ...
                    <input class="etbl-search" id="mtbl-search" type="text" placeholder="Search movement..."
                        oninput="mtblSearch(this.value)">
                </div>
        ...
        {{-- ── FILTER BAR ── --}}
        <div class="etbl-filterbar" id="mtbl-filterbar">
            <span style="font-size:12px;color:#6b7280;font-weight:600;margin-right:2px;">Filter:</span>

            <button class="etbl-filter-chip active" onclick="mtblFilter(this, 'all')">All</button>

            <button class="etbl-filter-chip" onclick="mtblFilter(this, 'in')">
            ...
            <button class="etbl-filter-chip" onclick="mtblFilter(this, 'out')">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2">
            ...
            <button class="etbl-filter-chip" onclick="mtblFilter(this, 'completed')">Completed</button>
            <button class="etbl-filter-chip" onclick="mtblFilter(this, 'processing')">Processing</button>
            <button class="etbl-filter-chip" onclick="mtblFilter(this, 'cancelled')">Cancelled</button>

            <button class="etbl-btn-reset ms-auto" onclick="mtblReset()">Reset All</button>
        </div>
        ...
        <div class="etbl-col-controls">
            ...
            <button class="etbl-col-sort-btn active" id="sort-movement_date" onclick="mtblSort('movement_date', this)">
            ...
            <button class="etbl-col-sort-btn" id="sort-product" onclick="mtblSort('product', this)">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <polyline points="6 9 12 15 18 9" />
                </svg>
                Product
            ...
            <button class="etbl-col-sort-btn" id="sort-order_id" onclick="mtblSort('order_id', this)">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <polyline points="6 9 12 15 18 9" />
                </svg>
                Order ID
            ...
            <button class="etbl-col-sort-btn" id="sort-qty" onclick="mtblSort('qty', this)">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <polyline points="6 9 12 15 18 9" />
                </svg>
                Qty
            ...
            <button class="etbl-col-sort-btn" id="sort-status" onclick="mtblSort('status', this)">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <polyline points="6 9 12 15 18 9" />
                </svg>
                Status
        ...
        <div class="etbl-infobar">
            <div class="etbl-infobar-left">
                Showing <strong id="mtbl-showing">{{ $movements->count() }}</strong>
                of <strong>{{ $movements->total() }}</strong> movements
                <span id="mtbl-filter-label"></span>
            </div>
        ...
        <div class="etbl-scroll">
            <table class="etbl-table" id="mtbl-table">
                <thead>
                    <tr>
                        <th class="no-sort">
                            <input type="checkbox" class="etbl-checkbox" id="mtbl-select-all"
                                onclick="toggleMovementSelectAll(this)" title="Select all">
                        </th>

                        <th onclick="mtblSortTh('product')" id="th-product">
                            <span class="th-inner">
                                Product
                        ...
                        <th onclick="mtblSortTh('order_id')" id="th-order_id">
                            <span class="th-inner">
                                Order ID
                                <span class="sort-arrows">
                                    <svg viewBox="0 0 10 6">
                        ...
                        <th onclick="mtblSortTh('movement_date')" id="th-movement_date" class="sort-asc">
                            <span class="th-inner">
                                Date
                                <span class="sort-arrows">
                                    <svg viewBox="0 0 10 6">
                        ...
                        <th onclick="mtblSortTh('type')" id="th-type">
                            <span class="th-inner">
                                Type
                                <span class="sort-arrows">
                                    <svg viewBox="0 0 10 6">
                        ...
                        <th onclick="mtblSortTh('qty')" id="th-qty">
                            <span class="th-inner">
                                Qty
                                <span class="sort-arrows">
                                    <svg viewBox="0 0 10 6">
                        ...
                        <th onclick="mtblSortTh('shipped_to')" id="th-shipped_to">
                            <span class="th-inner">
                                Shipped To
                                <span class="sort-arrows">
                                    <svg viewBox="0 0 10 6">
                        ...
                        <th onclick="mtblSortTh('done_by')" id="th-done_by">
                            <span class="th-inner">
                                Done By
                                <span class="sort-arrows">
                                    <svg viewBox="0 0 10 6">
                        ...
                        <th onclick="mtblSortTh('note')" id="th-note">
                            <span class="th-inner">
                                Remark
                                <span class="sort-arrows">
                                    <svg viewBox="0 0 10 6">
                        ...
                        <th class="no-sort">Status Update</th>
                ...
                <tbody id="mtbl-tbody">
                    ...
                    if (blank($movement->tracking_number)) $missingFields[] = 'tracking';
                    if (blank($movement->carrier)) $missingFields[] = 'carrier';
                    if (blank($movement->shipped_to)) $missingFields[] = 'destination';


                    $needsUpdate = count($missingFields) > 0;
                    @endphp
                    <tr data-product="{{ strtolower($movement->product->name_en ?? '-') }}"
                        ...
                        data-needs_update="{{ $needsUpdate ? '1' : '0' }}">
                        <td>
                            <input type="checkbox" class="etbl-checkbox mtbl-row-check" value="{{ $movement->id }}">
                        </td>
                        ...
                        <td>
                            ...
                            <a href="{{ route('igloohome.movements.edit', $movement->id) }}" class="etbl-act-btn edit">
                                ✏️ Update
                            </a>
                            <br>
                        ...
                        <td>
                            Shipped on: {{ $movement->shipped_on ?? '-' }}<br>
                            Tracking: {{ $movement->tracking_number ?? '-' }} ({{ $movement->carrier ?? '-' }})<br>
                        ...
                        <td>
                            <form action="{{ route('igloohome.movements.updateStatus', $movement->id) }}" method="POST">
                                @csrf
                                @method('PATCH')
                                <select name="status" class="etbl-status-select" onchange="this.form.submit()">
                                    <option value="initialized"
                                        {{ $movement->status == 'initialized' ? 'selected' : '' }}>Initialized</option>
                                    <option value="processing"
                                        {{ $movement->status == 'processing' ? 'selected' : '' }}>Processing</option>
                                    <option value="packed" {{ $movement->status == 'packed' ? 'selected' : '' }}>Packed
                                    </option>
                                    <option value="shipped" {{ $movement->status == 'shipped' ? 'selected' : '' }}>
                                        Shipped</option>
                        ...
                        <td>
                            <div class="etbl-actions">
                                <a href="{{ route('igloohome.movements.edit', $movement->id) }}"
                                    class="etbl-act-btn edit">
                                    ✏️ Edit
                                </a>
                            </div>
                        </td>
                    ...
                    <tr id="mtbl-no-results" style="display:none;">
                        <td colspan="14">
                            <div class="etbl-empty">
                                <svg width="48" height="48" fill="none" stroke="#6b7280" stroke-width="1.5"
                                    viewBox="0 0 24 24">
...
(function() {
    ...
    function rows() {
        return Array.from(document.querySelectorAll('#mtbl-tbody tr[data-product]'));
    }
    ...
    function applyVisibility() {
        ...
        document.getElementById('mtbl-showing').textContent = visible;
        document.getElementById('mtbl-no-results').style.display = visible === 0 ? '' : 'none';
    }

    window.mtblSearch = function(val) {
        currentSearch = val;
        applyVisibility();
    };

    window.mtblFilter = function(btn, filter) {
        document.querySelectorAll('#mtbl-filterbar .etbl-filter-chip').forEach(b => b.classList.remove(
            'active'));
        ...
        document.getElementById('mtbl-filter-label').textContent = label;

        applyVisibility();
    };

    window.mtblReset = function() {
        currentSearch = '';
        currentFilter = 'all';
        document.getElementById('mtbl-search').value = '';
        document.querySelectorAll('#mtbl-filterbar .etbl-filter-chip').forEach((b, i) => {
            b.classList.toggle('active', i === 0);
        });
        document.getElementById('mtbl-filter-label').textContent = '';
        applyVisibility();
    };

    function sortRows(col, dir) {
        const tbody = document.getElementById('mtbl-tbody');
    ...
    window.mtblSort = function(col, btn) {
    ...
    window.mtblSortTh = function(col) {
        if (currentSort.col === col) {
            currentSort.dir = currentSort.dir === 'asc' ? 'desc' : 'asc';
        } else {
            currentSort = {
    ...
    window.toggleMovementSelectAll = function(cb) {
        document.querySelectorAll('.mtbl-row-check').forEach(c => {
