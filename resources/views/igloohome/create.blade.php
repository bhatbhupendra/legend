...
<div class="box-panel">
    <div class="eform-wrapper">
        ...
        <div class="eform-topbar">
            <div>
                <h4 class="eform-title mb-0">
                    {{ isset($product) ? 'Edit Igloohome Product' : 'Create Igloohome Product' }}
                </h4>
        ...
        <div class="eform-infobar">
            <span class="eform-info-chip"><strong>Module:</strong> Igloohome Inventory</span>
        ...
        <form action="{{ isset($product) ? route('igloohome.update', $product->id) : route('igloohome.store') }}"
            method="POST">
            @csrf
            @if(isset($product))
            @method('PUT')
            ...
            <div class="eform-footer">
                ...
                <div class="eform-btn-group">
                    <a href="{{ route('igloohome.index') }}" class="eform-btn eform-btn-secondary">
                        ↩ Cancel
                    </a>
